...
export function coreBehaviorTests(context, batchConfig) {
    ...
    describe("Core Parity", () => {
        ...
        describe("MULTIPLY Change Mode", () => {
            it("should add to existing value",
                defineActiveEffectChangeTest(
                    [ { key: "data.currency.pp", mode: globalThis.CONST.ACTIVE_EFFECT_MODES.MULTIPLY, value: "2" } ],
        ...
        describe("UPGRADE Change Mode", () => {
            it("should upgrade lower existing value",
                defineActiveEffectChangeTest(
                    [ { key: "data.currency.pp", mode: globalThis.CONST.ACTIVE_EFFECT_MODES.UPGRADE, value: "15" } ],
        ...
        describe("DOWNGRADE Change Mode", () => {
            it("should downgrade higher existing value",
                defineActiveEffectChangeTest(
                    [ { key: "data.currency.pp", mode: globalThis.CONST.ACTIVE_EFFECT_MODES.DOWNGRADE, value: "15" } ],
                    [ { key: "data.currency.pp", value: 15 } ],
                    { actorData: { "data.currency.pp": 20 } },
                ),
            );
            ...
            it("should apply changes to the appropriate keys ",
                defineActiveEffectChangeTest(
                    [
                        ...
                        { key: "data.currency.gp", mode: globalThis.CONST.ACTIVE_EFFECT_MODES.OVERRIDE, value: "13" },
                    ],
                    [
                        { key: "data.currency.pp", value: 42 },
        ...
        describe("Multiple changes, same key", () => {
            ...
            it("should apply ADD and MULTIPLY changes in order of implicit priority",
                defineActiveEffectChangeTest(
                    [
                        { key: "data.currency.pp", mode: globalThis.CONST.ACTIVE_EFFECT_MODES.ADD, value: "3" },
                        { key: "data.currency.pp", mode: globalThis.CONST.ACTIVE_EFFECT_MODES.MULTIPLY, value: "5" },
                    ],
            ...
            it("should apply OVERRIDE and ADD changes in order of given priority",
                defineActiveEffectChangeTest(
                    [
                        { key: "data.currency.pp", mode: globalThis.CONST.ACTIVE_EFFECT_MODES.OVERRIDE, value: "40", priority: 0 },
                        { key: "data.currency.pp", mode: globalThis.CONST.ACTIVE_EFFECT_MODES.ADD, value: "2", priority: 1 },
                    ],
                    [ { key: "data.currency.pp", value: 42 } ],
        ...
        describe("Weird Cases", () => {
            it("should create the target effect path if it does not already exist",
                defineActiveEffectChangeTest(
                    [
                        { key: "flags.myCustomKey1", mode: globalThis.CONST.ACTIVE_EFFECT_MODES.OVERRIDE, value: "Hello, world!" },
                        { key: "flags.myCustomKey2", mode: globalThis.CONST.ACTIVE_EFFECT_MODES.OVERRIDE, value: "Something else" },
                    ],
                    [
            ...
            it("should add to target effect path even if the target key is not defined in the schema",
                defineActiveEffectChangeTest(
                    [
                        { key: "flags.myCustomKey", mode: globalThis.CONST.ACTIVE_EFFECT_MODES.ADD, value: ", world!" },
                    ],
